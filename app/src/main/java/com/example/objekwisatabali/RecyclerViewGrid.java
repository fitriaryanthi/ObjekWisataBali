...
public class RecyclerViewGrid extends RecyclerView.Adapter<RecyclerViewGrid.ViewHolder> {
    ...
    public RecyclerViewGrid(Context context, ArrayList<String> nama, ArrayList<String> alamatwisata, ArrayList<String> deskripsiwisata, ArrayList<String> foto, ArrayList<String> lokasi, ArrayList<String> kategori) {
        names = nama;
        alamat = alamatwisata;
